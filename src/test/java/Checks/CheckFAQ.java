...
public class CheckFAQ extends Check {

    private String expected;
    private int questionIndex;

    public CheckFAQ(int questionIndex, String expected) {
        this.questionIndex = questionIndex;
        this.expected = expected;
    }

    @Parameterized.Parameters
    public static Object[][] checkAnswersData() {
        return new Object[][]{
    ...
    public static void classSetup() {
        ...
        driver.get(AppConfig.HOME_PAGE_URL);
    }
    ...
    public void checkAnswersText() {
        Assert.assertEquals(
                ...
                expected,
                new HomePageScooter(driver).getAnswerText(questionIndex)
        );
    }
